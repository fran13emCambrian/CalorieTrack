...
namespace CalorieAppTrack.Controllers
{
    public class UserModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,LastName")] UserModel userModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,LastName")] UserModel userModel)
        {
